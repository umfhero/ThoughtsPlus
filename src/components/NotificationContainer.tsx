...
function NotificationItem({ notification }: { notification: Notification }) {
    ...
    const borderColor = getGlassColor(accentColor, 0.3);
    ...
    return (
        <motion.div
            ...
            style={{
                ...
                boxShadow: `0 4px 20px -2px ${getGlassColor(accentColor, 0.1)}`
            }}
        >
            <div className="relative p-4">
                <div className="flex items-start gap-3">
                    <div 
                        ...
                        style={{ backgroundColor: getGlassColor(accentColor, 0.1) }}
                    >
                    ...
                    <div className="flex-1">
                        ...
                        {notification.action && (
                            <button
                                ...
                                style={{ 
                                    backgroundColor: getGlassColor(accentColor, 0.1),
                                    color: accentColor
                                }}
                            >
